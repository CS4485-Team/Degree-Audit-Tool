...
public class IntelSysPDF extends DefaultPDF {
    ...
    public void createPdf(String dest) throws IOException, DocumentException {
        ...
        String rcTitles[] = { "Natural Language Processing", "Design and Analysis of Computer Algorithms",
                "Artificial Intelligence", "Machine Learning", PDFBuilder.EMPTY };
        String rcCourseNums[] = { "   CS6320  ", "   CS6363  ", "   CS6364  ", "   CS6375  ", PDFBuilder.EMPTY };
        ...
        Font ccTitleSize[] = { PDFBuilder.FONT_SEVENPTFIVE, PDFBuilder.FONT_SEVENPTFIVE, PDFBuilder.FONT_SEVENPTFIVE };
        Font ccOtherSize[] = { PDFBuilder.FONT_NINE, PDFBuilder.FONT_NINE, PDFBuilder.FONT_NINE };
        String ccTitles[] = { "Database Design", "Advanced Operating Systems", PDFBuilder.EMPTY };
        String ccCourseNums[] = { "   CS6347  ", "   CS6378  ", PDFBuilder.EMPTY };
        String ccSems[] = { PDFBuilder.EMPTY, PDFBuilder.EMPTY, PDFBuilder.EMPTY };
        String ccTransfer[] = { PDFBuilder.EMPTY, PDFBuilder.EMPTY, PDFBuilder.EMPTY };
        String ccGrade[] = { PDFBuilder.EMPTY, PDFBuilder.EMPTY, PDFBuilder.EMPTY };
